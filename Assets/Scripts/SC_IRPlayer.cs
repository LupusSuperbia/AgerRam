...
public class SC_IRPlayer : MonoBehaviour
{
    ...
    public float fov = 0f;
    [Header("Movimiento")]
    [SerializeField] public float lateralSpeed = 10.0f;
    ...
    void InputFunction()
    {
        ...
        if (mouse.leftButton.wasPressedThisFrame) weaponPlayer.TryShoot();
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Obstacle") || other.CompareTag("Trash") )
        {
            ...
            if (objRb != null)
            {
                ...
                objRb.AddForce(direction * 4f * (-3f) * SC_GroundGenerator.instance.movingSpeed, ForceMode.Impulse);
